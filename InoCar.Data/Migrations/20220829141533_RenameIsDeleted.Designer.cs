...
namespace InoCar.Data.Migrations
{
    ...
    [Migration("20220829141533_RenameIsDeleted")]
    partial class RenameIsDeleted
    {
            ...
            modelBuilder.Entity("InoCar.Data.Entities.DealershipFeedback", b =>
                {
                    ...
                    b.Property<DateTime>("PublicDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 29, 14, 15, 32, 56, DateTimeKind.Utc).AddTicks(8561));
            ...
            modelBuilder.Entity("InoCar.Data.Entities.ServiceRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreateRequestDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 29, 17, 15, 32, 49, DateTimeKind.Local).AddTicks(906));
            ...
            modelBuilder.Entity("InoCar.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d32cab1f-0689-4ba5-96f0-93cba9b0b4d8",
                            AccessFailedCount = 0,
                            City = "Admin1",
                            ConcurrencyStamp = "c021eb05-f2cb-47cc-b852-4ce187304555",
                            DateBirth = new DateTime(2022, 8, 29, 14, 15, 32, 345, DateTimeKind.Utc).AddTicks(3609),
                            ...
                            LastName = "Admin1",
                            LockoutEnabled = true,
                            NormalizedEmail = "JOHN-OLD@MAIL.RU",
                            NormalizedUserName = "ADMIN1",
                            PasswordHash = "$2a$11$daR74tscUrYWUJq6MC8NbeeMnxYA9fBFUeq5BVsZstzj9H6Qg90ye",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "06c32006-28db-4757-90dd-48e023412a60",
