...
namespace InoCar.Data.Migrations
{
    ...
    [Migration("20220825143842_DeleteUserRepeatingCulumn")]
    partial class DeleteUserRepeatingCulumn
    {
            ...
            modelBuilder.Entity("InoCar.Data.Entities.DealershipFeedback", b =>
                {
                    ...
                    b.Property<DateTime>("PublicDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 25, 14, 38, 41, 639, DateTimeKind.Utc).AddTicks(4149));
            ...
            modelBuilder.Entity("InoCar.Data.Entities.ServiceRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreateRequestDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 25, 17, 38, 41, 636, DateTimeKind.Local).AddTicks(5653));
